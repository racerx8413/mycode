upload_content = [
  ...
  { content = "Additional Content 1! (created via our dynamic block)", file = "/terraform/test3.txt", executable = true },
  { content = "Additional Content 2! (created via our dynamic block)", file = "/terraform/test4.txt", executable = true },
]
